...
export const CircularRevealHeading = ({
    ...
    return (
        <>
            ...
            <motion.div
                whileHover={{
                    boxShadow: "20px 20px 40px rgba(0,0,0,0.4), -20px -20px 40px rgba(255,255,255,0.1)"
                }}
                whileTap={{ scale: 0.98 }}
                animate={{ y: [0, -8, 0] }}
                transition={{
                ...
                className={cn(
                    ...
                    "shadow-[16px_16px_32px_rgba(0,0,0,0.2),-16px_-16px_32px_rgba(255,255,255,0.1)]",
            ...
            >
                ...
                <motion.div
                    className="absolute inset-[12px] rounded-full bg-white"
                    style={{
                    ...
                    <AnimatePresence>
                        {!activeImage && (
                            <motion.div
                                ...
                                animate={{ opacity: 1 }}
                                transition={{ duration: 0.3 }}
                                className="relative z-10 p-6 rounded-3xl bg-white"
                                whileHover={{
                                    boxShadow: "inset 3px 3px 6px rgba(0,0,0,0.08), inset -3px -3px 6px rgba(255,255,255,0.6)"
                                }}
                            >
                                {centerText}
                            </motion.div>
