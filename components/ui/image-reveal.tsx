...
const ImageReveal = React.forwardRef<HTMLDivElement, ImageRevealProps>(
  ({ variant = 'default', size = 'default', asChild, className, children, images = defaultImages, ...props }, ref) => {
    ...
    const variantClasses = {
      default: 'bg-gradient-to-b from-black from-10% to-gray-950 to-100%',
      'blue-theme': 'bg-gradient-to-b from-blue-900 from-10% to-blue-950 to-100%',
      'green-theme': 'bg-gradient-to-b from-green-900 from-10% to-green-950 to-100%',
    };
      ...
      >
        {images.map((image) => (
          ...
          >
            ...
            <h2
              className={cn(
                `font-poppins uppercase font-semibold sm:py-6 py-2 leading-[100%] relative`,
                h2SizeClasses[size],
        ...
        {isDesktop && activeImage && (
          <img
            src={activeImage.src}
            alt={activeImage.alt}
            className={`fixed bg-gray-950 object-cover pointer-events-none z-10 w-[300px] h-[400px] rounded-lg`}
            style={{
