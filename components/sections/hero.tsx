...
export function HeroSection() {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-black text-white px-4">
      ...
      <div className="container relative z-20 py-20 md:py-32 text-center px-4 md:px-6">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
          ...
          <span className="block text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-3 md:mt-4 font-light text-gray-300">
            Excelencia en cada detalle
          </span>
        </h1>
        <p className="mx-auto max-w-[280px] sm:max-w-[400px] md:max-w-[600px] lg:max-w-[700px] text-gray-400 text-sm sm:text-base md:text-lg lg:text-xl mt-6 md:mt-8">
        ...
        <div className="mt-8 md:mt-12 flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4 sm:px-0">
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-white text-white hover:bg-white hover:text-black w-full sm:w-auto px-6 md:px-8"
          >
            Contactar
          </Button>
        </div>
